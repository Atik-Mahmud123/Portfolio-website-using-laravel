...
<html lang="en">
    <head>
        ...
        <title>Portfolio - Learning | ATIK</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                {{-- <a class="navbar-brand" href="#page-top"><img src="assets/img/navbar-logo.svg" alt="..." />Atik | Learning</a> --}}
                <a class="navbar-brand" href="#page-top"><img src="" alt="" />Atik | Learning</a>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Some of the tasks that I have finished.</h3>
                </div>
                <div class="row">
